...
class Config
{
	...
	const PRODUCTION_URL_US = "https://stc.pagseguro.uol.com.br/pagseguro/api/v2/checkout/pagseguro.directpayment.js";
	...
	public static function getUrlJS()
	{
		...
		return (Config::SANDBOX === true) ? Config::SANDBOX_URL_JS : Config::PRODUCTION_URL_US;
